...
export default function App() {
  ...
  const handleSubmit=useCallback(async e=>{
    ...
    try{
      await emailjs.send("service_k1v326l","template_rnicy46",{name:formData.name,email:formData.email,number:formData.number,message:formData.message,time:new Date().toLocaleString()});
    ...
    <>
      ...
      <div className={`loader-wrap${loaded?" hidden":""}`}>
        <div className="loader-inner">
          <div className="loader-line">$ ssh abhay@portfolio.dev</div>
        ...
        <div className="container">
          <div className="hero-layout">
            <div>
              ...
              <h1 className="hero-title reveal reveal-delay-1">ABHAY<br/><span className="name-green">THAKUR</span></h1>
            ...
            <div className="terminal-card reveal-right reveal-delay-2">
              ...
              <div className="terminal-body">
                ...
                <div className="t-line"><span className="t-out">&nbsp;&nbsp;<span className="t-blue">"name"</span>: <span className="t-green">"Abhay Thakur"</span>,</span></div>
        ...
        <div className="container">
          <div className="about-grid">
            <div className="reveal-left">
              <div className="about-code-block">
                ...
                <div className="code-content">
                  <div><span className="ln">1</span><span className="cm">// Abhay Thakur — Developer Profile</span></div>
            ...
            <div>
              ...
              <p className="about-body reveal reveal-delay-2">I'm Abhay Thakur — a B.Tech CSE student at LPU with a passion for building systems that scale. My foundation is rooted in Data Structures & Algorithms using C++ and Java, giving me the mental framework to tackle complex problems with precision.</p>
          ...
          <div className="contact-grid">
            <div>
              ...
              <div className="contact-socials">
                <a href="mailto:abhayth2705@gmail.com" className="social-link reveal reveal-delay-1">
                  <div className="social-icon">✉️</div>
                  <div><div className="social-name">Email</div><div className="social-handle">abhayth2705@gmail.com</div></div>
                </a>
                <a href="https://github.com/Abhaythakur27" target="_blank" rel="noreferrer" className="social-link reveal reveal-delay-2">
                  <div className="social-icon"><GitHubIcon/></div>
                  <div><div className="social-name">GitHub</div><div className="social-handle">@Abhaythakur27</div></div>
                </a>
                <a href="https://www.linkedin.com/in/abhay27/" target="_blank" rel="noreferrer" className="social-link reveal reveal-delay-3">
                  <div className="social-icon">💼</div>
                  <div><div className="social-name">LinkedIn</div><div className="social-handle">abhay27</div></div>
                </a>
                <a href="tel:+91 8219651535" className="social-link reveal reveal-delay-4">
                  <div className="social-icon">📱</div>
